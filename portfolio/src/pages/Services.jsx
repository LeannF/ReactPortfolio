            ...
            <section className="container text-center my-5">
                ...
                <div className="row">
                    <div className="col-md-4 mb-5">
                        <div className="card">
                            <div className="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-brush text-primary m-4" viewBox="0 0 16 16">
                                ...
                                <h2 className="card-title fw-bold">UX Design</h2>
                    ...
                    <div className="col-md-4 mb-5">
                        <div className="card ">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-code-slash text-primary m-4" viewBox="0 0 16 16">
                                ...
                                <h2 className="card-title fw-bold">Développement web</h2>
                                <p className="card-text m-4">
                    ...
                    <div className="col-md-4 mb-5">
                        <div className="card">
                            <div className="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-search text-primary m-4" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                            </svg>
                                <h2 className="card-title fw-bold">Réferencement</h2>
                                <p className="card-text m-4">
