const Contact = () => {
    return(
        <main className="container text-center">
            ...
            <section className="container shadow-lg rounded-1 p-4 my-5">
                <div className="row">
                    <div className="col-md-6">
                        <h2 id="titleBorder" className="text-start">Formulaire de contact</h2>

                        <form action="submit">
                            <input type="name" className="form-control mb-3" id="FormControlInput1" placeholder="Votre nom" required/>
                            <input type="email" className="form-control mb-3" id="FormControlInput2" placeholder="Votre adresse mail" required/>
