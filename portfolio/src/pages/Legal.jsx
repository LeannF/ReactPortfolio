...
const Legal = () => {
    return(
        <main>
            ...
            <section>
                <div className="container accordion mb-5" id="accordion">
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordion">
                            <div className="accordion-body">
                                ...
                                <Link className="px-1" to="https://www.alwaysdata.com/fr/">www.alwaysdata.com</Link>
                            </div>
                        </div>
                    </div>
                    <div className="accordion-item">
                        ...
                        <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordion">
                            <div className="accordion-body">
                                ...
                                <p>Ce site a été réalisé par Léann Farant, étudiante au <Link to="https://urlr.me/JmTgpR" target="_blank">Centre Européen de formation.</Link></p>
                                <p>Les images utilisées sur ce site sont libres de droit et ont été obtenues sur le site <Link to="https://pixabay.com/fr/" target="_blank">Pixabay</Link></p>
                                <p>Le favicon de ce site a été fournie par <Link to="https://www.flaticon.com/de/kostenlose-icons/john-doe" target="_blank">John Doe Icons erstellt von Freepik - Flaticon </Link></p>
                            </div>
                        </div>
                    </div>
                </div>
